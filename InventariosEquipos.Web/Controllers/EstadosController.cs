...
namespace InventariosEquipos.Web.Controllers
{
    public class EstadosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreEstado")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreEstado")] Estado estado)
        {
            if (id != estado.Id)
            {
                return NotFound();
